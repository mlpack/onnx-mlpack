...
torch.onnx.export(model, (x,), "pytorch_linear.onnx", input_names=["x"],
    dynamo=False, external_data=False)
torch.onnx.export(model, (x,), "pytorch_linear_dynamo.onnx", input_names=["x"],
...
np.savetxt("pytorch_linear_inputs.csv", x_np, delimiter=',')
np.savetxt("pytorch_linear_outputs.csv", y_pred_np, delimiter=',')
