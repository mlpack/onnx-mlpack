 ...
 *
 * Extract ONNX attributes from an ONNX graph.
 */
#ifndef ONNX_MLPACK_ATTRIBUTE_HPP
#define ONNX_MLPACK_ATTRIBUTE_HPP
 ...
 * @return A map where each key-value pair represents an attribute name and its
 *     value.
 *
 * Example output for a Convolution node:
 *
 * {
 *   {"paddingType", 0.0},
 *   {"auto_pad", 0.0},
...
#endif // ONNX_MLPACK_ATTRIBUTE_HPP
