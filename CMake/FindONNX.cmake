...
if (NOT "${_ONNX_VERSION_MAJOR}" STREQUAL "")
  ...
  string(REGEX REPLACE "^#define ONNX_VERSION_MAJOR.*([0-9]*).*$"
      ONNX_VERSION_MAJOR ${_ONNX_VERSION_MAJOR})
  string(REGEX REPLACE "^#define ONNX_VERSION_MINOR.*([0-9]*).*$"
      ONNX_VERSION_MINOR ${_ONNX_VERSION_MINOR})
  string(REGEX REPLACE "^#define ONNX_VERSION_PATCH.*([0-9]*).*$"
